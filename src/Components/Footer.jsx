    ...
    <footer className="bg-gradient-to-br from-purple-500 to-indigo-600 text-white">
      ...
      <div className="footer p-10">
        <div>
          ...
          <p>
            <strong>Confidence Cable Network Ltd.</strong>
            <br />
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a href="mailto:example@email.com" className="link link-hover">
              📧 Email
            </a>
      ...
      <div className="text-center py-4">
        <p className="text-sm text-gray-600">
          &copy; {new Date().getFullYear()} DK Technologies. All Rights
          Reserved.
        </p>
      </div>
    </footer>
